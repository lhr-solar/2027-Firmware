...
import type { CanMessage, CanNetwork, SearchFields } from "../types";
    ...
    <div className="dbc-viewer">
      <div className="dbc-toolbar">
        ...
        <div className="dbc-select-row">
          <label className="dbc-field">
            <span className="dbc-label">Network</span>
            <select
              className="dbc-select"
              value={network.id}
              onChange={(e) => navigate(`/n/${encodeURIComponent(e.target.value)}`)}
            >
              {networks.map((n) => (
        ...
        <div className="breadcrumb compact">
          ...
          <Link to={`/summary/${encodeURIComponent(network.id)}`}>Summary</Link>
          <span className="bc-sep">/</span>
      ...
      <div className="dbc-scroll">
        <details className="vt-details messages-details" open>
          <summary>Messages ({sortedMessages.length})</summary>
